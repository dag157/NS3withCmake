...
//NS_LOG_COMPONENT_DEFINE ("FirstScriptExample2Visualizer");
...
//  NS_LOG_UNCOND ("Checkpoint 1");
  //LogComponentDisable("Time",LOG_LEVEL_INFO);
  GlobalValue::Bind ("SimulatorImplementationType", StringValue ("ns3::VisualSimulatorImpl"));

//  NS_LOG_UNCOND ("Checkpoint 2");
